    ...
    this.newUser = fb.group(
      {
        ...
        mobile_number: ['', [Validators.required, Validators.min(1), Validators.max(9999999999999)]],
        home_number: ['', [Validators.required, Validators.min(1), Validators.max(9999999999999)]],
